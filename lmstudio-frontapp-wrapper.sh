#!/bin/bash
# LM Studio MCP Wrapper Script for Frontapp
# This script allows LM Studio to communicate with the MCP server running in Docker
...
# This pipes stdin/stdout between LM Studio and the container
exec docker exec -i \
